...
<% //Cへ検索する条件を送る %>
	<form method="POST" name=MyForm action="<%= request.getContextPath() %>/G0030Control">
		会社ID:
		<input type="text" name="companyId" placeholder="会社ID"  style="text-align: left;">
		会社名:
		<input type="text" name="companyName" placeholder="会社名"  style="text-align: left;">
		会社住所:
		<input type="text" name="companyAddress" placeholder="会社住所"  style="text-align: left;">
