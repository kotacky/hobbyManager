...
<%-- Cへ検索する条件を送る --%>
	<form method="POST" name="MyForm" action="<%= request.getContextPath() %>/G0020Control">
			女優ID:
			<input type="text" id="actressId" name="actressId" placeholder="女優ID" value="<%= request.getParameter("actressId") %>" style="text-align: left;">
			女優名:
			<input type="text" id="actressName" name="actressName" placeholder="女優名" value="<%= request.getParameter("actressName") %>" style="text-align: left; ">
