...
<%-- Cへ登録する条件を送る --%>
	<form method="POST" action="<%=request.getContextPath() %>/G0111Control">
		アーティストID:
		<input type="text" name="artistId" placeholder="19XX" style="text-align:left;"  required>（必須）<br>
		アーティスト名:
		<input type="text" name="artistName" placeholder="アーティスト名" style="text-align:left;" required>（必須）<br>
